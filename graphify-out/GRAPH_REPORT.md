...
## Corpus Check
- 151 files · ~1,485,521 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 767 nodes · 1433 edges · 43 communities (39 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c8bf5764`
...
Cohesion: 0.10
Nodes (22): GET(), AUDIT_RUN_STATUSES, AuditRunDoc, auditRunSchema, auditRunSummarySchema, cascadeDeleteFindings(), diagnosticsSchema, fileErrorSchema (+14 more)
...
Cohesion: 0.13
Nodes (17): CheckStatus, GET(), GET(), GET(), FINDING_CATEGORIES, Requirement, REQUIREMENT_SOURCE_TYPES, REQUIREMENT_STATUSES (+9 more)
...
Cohesion: 0.19
Nodes (15): loadEnabledRules(), runAuditRules(), dedupeKey(), EMPTY_SUMMARY(), runRules(), RunRulesResult, RunRulesSummary, summarizeFindings() (+7 more)
...
Cohesion: 0.07
Nodes (38): captureRuleVersionSnapshot(), extractSourceSnippet(), loadThemeFindingHistory(), POST(), toFindingDocs(), GET(), toPlainRecord(), AuditDiagnostics (+30 more)
...
### Community 44 - "accessibility/index.test.ts"
Cohesion: 0.18
Nodes (4): RuleFinding, ACCESSIBILITY_RULES, CROSS_FILE_RULES, BASE_LAYOUT

## Knowledge Gaps
- **283 isolated node(s):** `SheetFindingRow`, `RGB`, `HEADER_BACKGROUND`, `HEADER_TEXT`, `SEVERITY_COLORS` (+278 more)
...
- **Why does `connectToDatabase()` connect `connectToDatabase` to `run/route.ts`, `oauth.ts`, `finding.ts`, `requirement.ts`, `[id]/export/route.ts`, `readiness/route.ts`, `seed-rules.ts`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `devDependencies` to `dependencies`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **What connects `SheetFindingRow`, `RGB`, `HEADER_BACKGROUND` to the rest of the system?**
