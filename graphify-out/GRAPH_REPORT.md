...
## Corpus Check
- 186 files · ~1,538,708 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1023 nodes · 1953 edges · 67 communities (61 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `60cf738f`
...
Cohesion: 0.39
Nodes (9): GET(), GET(), PATCH(), GET(), invalidIdResponse(), isValidObjectId(), connectToDatabase(), buildDiffCsv() (+1 more)
...
Cohesion: 0.08
Nodes (28): GET(), GET(), AUDIT_RUN_STATUSES, AuditRun, AuditRunDoc, auditRunSchema, auditRunSummarySchema, cascadeDeleteFindings() (+20 more)
...
Cohesion: 0.12
Nodes (25): checkResponsiveReachability(), comparePresets(), ContrastSample, evaluateReachabilityInPage(), extractLoadedPageFacts(), extractPageFacts(), findAndClickMenuTriggerInPage(), homepageFindings() (+17 more)
...
Cohesion: 0.11
Nodes (26): findFirstProductLink(), PresetLink, averageDefined(), collectPlaywrightMetrics(), discoverPageUrls(), extractCoreMetrics(), extractOpportunityFindings(), FallbackMetrics (+18 more)

### Community 25 - "readiness.ts"
Cohesion: 0.19
...
Cohesion: 0.10
Nodes (20): DiffFinding, BASE_TEMPLATE_LABELS, EXACT_TEMPLATE_LABELS, getPageLabel(), buildFindingsCsv(), COLUMNS, CsvFindingRow, escapeCsvField() (+12 more)
...
Cohesion: 0.15
Nodes (21): loadEnabledRules(), runAuditRules(), dedupeKey(), EMPTY_SUMMARY(), runRules(), RunRulesResult, RunRulesSummary, summarizeFindings() (+13 more)
...
Cohesion: 0.10
Nodes (20): FindingCategory, Rule, RuleContext, Severity, ThemeIndex, headingMatchesSectionNameRule, INTERNAL_RULES, imageDimensionsRule (+12 more)

### Community 54 - "[id]/export/route.ts"
Cohesion: 0.25
...
## Knowledge Gaps
- **383 isolated node(s):** `ReadinessStatus`, `SEVERITY_STYLES`, `STATUS_STYLES`, `READINESS_STYLES`, `READINESS_LABEL` (+378 more)
...
- **Why does `connectToDatabase()` connect `connectToDatabase` to `available-features/route.ts`, `oauth.ts`, `run/route.ts`, `[id]/export/google-sheet/route.ts`, `finding.ts`, `diffFindings.ts`, `enhancement-point.ts`, `connect.ts`, `[id]/export/route.ts`, `readiness/route.ts`, `seed-rules.ts`?**
