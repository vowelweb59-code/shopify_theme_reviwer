...
## Knowledge Gaps
- **426 isolated node(s):** `Tab`, `BreadcrumbItem`, `ButtonVariant`, `ButtonSize`, `VARIANT_CLASSES` (+421 more)
...
- **What connects `Tab`, `BreadcrumbItem`, `ButtonVariant` to the rest of the system?**
