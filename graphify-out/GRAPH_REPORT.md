...
## Corpus Check
- 238 files · ~1,558,514 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1226 nodes · 2414 edges · 78 communities (70 shown, 8 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `99f001db`
...
Cohesion: 0.08
Nodes (29): GET(), GET(), RequirementImplementationType, GET(), AuditSettings, AuditSettingsDoc, auditSettingsSchema, FINDING_CATEGORIES (+21 more)

### Community 20 - "extractReadmeVersion.ts"
Cohesion: 0.12
Nodes (21): countThemeDirectories(), InvalidThemeError, resolveThemeRoot(), THEME_DIRECTORIES, ExtractedTheme, extractEntries(), extractThemeZip(), MAX_FILE_COUNT (+13 more)
...
Cohesion: 0.13
Nodes (15): BASE_TEMPLATE_LABELS, EXACT_TEMPLATE_LABELS, getPageLabel(), buildFindingsCsv(), COLUMNS, CsvFindingRow, escapeCsvField(), buildDiffCsv() (+7 more)

### Community 29 - "audit-run.ts"
Cohesion: 0.06
Nodes (54): GET(), GET(), GET(), POST(), GET(), PATCH(), POST(), POST() (+46 more)
...
Cohesion: 0.16
Nodes (16): CheckStatus, GET(), loadEnabledRules(), runAuditRules(), FindingCategory, dedupeKey(), EMPTY_SUMMARY(), ExecutedFinding (+8 more)
...
Cohesion: 0.22
Nodes (13): extractHtmlStructure(), isLiquidExpression(), parseOneFile(), parseThemeDirectory(), parseThemeZip(), ThemeParseTiming, emptyMetaTags(), emptyParsedFile() (+5 more)
...
Cohesion: 0.14
Nodes (20): CONTENT_TYPES, Format, FORMATS, GET(), GET(), computeCoverage(), computeCoverageByCategory(), CoverageResult (+12 more)
...
### Community 62 - "readiness/route.ts"
Cohesion: 0.33
...
### Community 69 - "FutureUpdatesContent.tsx"
Cohesion: 0.19
...
### Community 71 - "findingHistory.ts"
Cohesion: 0.29
...
## Knowledge Gaps
- **427 isolated node(s):** `CheckTotals`, `Props`, `ThemeVersionResult`, `VERSION_VALUE_RE`, `VERSION_LINE_RE` (+422 more)
...
- **Why does `connectToDatabase()` connect `connectToDatabase` to `oauth.ts`, `executeAuditRun.ts`, `[id]/export/google-sheet/route.ts`, `[id]/export/route.ts`, `enhancement-point.ts`, `seed-rules.ts`, `finding.ts`, `readiness/route.ts`, `audit-run.ts`, `diffFindings.ts`, `registry.ts`?**
...
- **What connects `CheckTotals`, `Props`, `ThemeVersionResult` to the rest of the system?**
